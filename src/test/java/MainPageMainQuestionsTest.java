...
public static Object[][] testQuestionsAnswers() {
    return new Object[][]{
        ...
        {"Можно ли заказать самокат прямо на сегодня?", "олько начиная с завтрашнего дня. Но скоро станем расторопнее."},
...
@Test
    public void testRecord() {
        ...
        mainPage.howMuchCostQuestionClick(question); //клик на вопрос
        assertTrue(mainPage.answerIsDisplayed(answer));//сравнили ответ
        driver.quit();
    }
    @After
    public void after(){
